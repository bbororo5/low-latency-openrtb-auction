...
- 리전별 사건은 회사 내부 집계를 위해 비동기로 병합한다. 업체 간 계약은 OpenRTB 통지 URL과 일반 HTTP 응답뿐이며 DSP는 재호출을 멱등 처리한다.
...
flowchart TB
    ...
    subgraph SSP["SSP 회사"]
        ...
        subgraph SR1["SSP 리전 1 · 다중 AZ"]
            ...
            SS1["SSP 리전 1 금액 사건 기록<br/>청구 근거·전달 결과"]
            SL1 --> SA1
            SA1 --- SS1
        end
        ...
        subgraph SR2["SSP 리전 2 · 다중 AZ"]
            ...
            SS2["SSP 리전 2 금액 사건 기록<br/>청구 근거·전달 결과"]
            SL2 --> SA2
            SA2 --- SS2
        end
    ...
    subgraph PDSP["프로젝트 DSP 회사"]
        ...
        subgraph DR1["DSP 리전 1 · 다중 AZ"]
            ...
            MONEY1["리전 1 금액 사건 기록<br/>통지 판정·리스 정산 근거"]
            DL1 --> GW1
            GW1 --> APP1
        ...
        subgraph DR2["DSP 리전 2 · 다중 AZ"]
            ...
            MONEY2["리전 2 금액 사건 기록<br/>통지 판정·리스 정산 근거"]
            DL2 --> GW2
            GW2 --> APP2
