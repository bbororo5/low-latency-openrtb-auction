...
- 세부 사용량이 늦거나 유실되어도 리전 책임 봉투는 늘어나지 않는다.
...
- 전역 미할당액과 두 리전 책임 봉투의 합이 항상 총예산과 같다.
- 각 리전의 미발급액·DSP 잔여 권한·잠재·확정 지출·격리액의 합이 자기 책임 봉투를 넘지 않는다.
- 내부 발급 기록 유실 뒤 불확실한 책임액을 조기 재할당하지 않는다.
- 한 리전 장애 중 다른 리전은 자기 책임액으로 입찰을 계속한다.
- 전역↔리전 책임 이전의 중복·응답 유실이 책임액을 늘리지 않는다.
- 지역 금액 사건을 재생하면 캠페인 금액 효과와 대조 투영을 다시 만들 수 있다.
